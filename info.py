...
USERNAME = environ.get('USERNAME', "https://telegram.me/Decentralised_internet")
...
LOG_API_CHANNEL = int(environ.get('LOG_API_CHANNEL', '-1002145018097'))
...
BIN_CHANNEL = int(environ.get('BIN_CHANNEL','-1002145018097'))
...
REF_PREMIUM = 30
PREMIUM_POINT = 1500
auth_channel = environ.get('AUTH_CHANNEL', '-1002025646370')
...
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1002025646370'))
